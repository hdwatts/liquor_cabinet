...
describe User do
  # let(:user) {User.create(email: "jane@yo.com", first_name: "jane", last_name: "doe", birth_date: "1990-12-12", password: "asdf")}
  ...
  it "is invalid without a real email address" do
    user1 = User.new(email: "jane@gmail")
    user1.valid?
    expect(user1.errors[:email]).to eq(["is not an email"])
  end

  it "is invalid without a unique email address" do  
    user1 = User.create(email: "jane@yo.com", first_name: "jane", last_name: "doe", birth_date: "1990-12-12", password: "asdf")
    user2 = User.create(email: "jane@yo.com", first_name: "jane", last_name: "doe", birth_date: "1990-12-12", password: "asdf")
    user2.valid?
