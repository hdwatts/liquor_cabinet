...
manhattan = Recipie.create(name: "Manhattan", difficulty: 5, description: "When properly built, the Manhattan is the only cocktail that can slug it out toe-to-toe with the martini. It's bold and fortifying, yet as relaxing as a deep massage.", servings: 1, steps: "Fill a short glass 2/3 full with ice. Add bitters, vermouth, and bourbon. Add cherry (and crush it against the side of the glass with a spoon). Stir.", image_url: "http://www.bonappetit.com/wp-content/uploads/2010/05/mare-manhattan-v.jpg", user_id: 1)
cucumber_margarita = Recipie.create(name: "Spicy Cucumber Margarita", difficulty: 4, description: "A refreshing summer treat with cooling cucumber flavors.", servings: 12, steps: "Bring sugar and 1/3 cup water to a boil in a saucepan, stirring to dissolve sugar. Let simple syrup cool. Combine simple syrup, tequila, lemon juice, lime juice, triple sec, and jalapeño in a pitcher. Chill for at least 30 minutes or up to 3 hours (taste every half-hour or so until spiced to your liking); remove jalapeño. Rub a lime wedge over half the rim of highball or rocks glasses; dip into kosher salt. Serve Margaritas over ice in prepared glasses; garnish with sliced cucumber and jalapeño.", image_url: "http://www.bonappetit.com/wp-content/uploads/2013/01/spicy-cucumber-margarita-940x600.jpg", user_id: 2)
paloma = Recipie.create(name: "Paloma", difficulty: 3, description: "It turns out the Paloma, not the Margarita, is Mexico's most beloved cocktail.", servings: 1, steps: "Pour some kosher salt on a plate. Rub half of rim of a highball glass with grapefruit wedge; dip rim of glass in salt. Combine grapefruit juice, lime juice, and sugar in glass; stir until sugar is dissolved. Stir in mescal, add ice, and top off with club soda. Garnish with grapefruit wedge.", image_url: "http://www.bonappetit.com/wp-content/uploads/2012/12/paloma-940x600.jpg", user_id: 3)
sidecar = Recipie.create(name: "Sidecar", difficulty: 2, tools: "shaker, strainer", description: "The Sidecar is often singled out as the only good cocktail to come out of the long national nightmare that was Prohibition.", servings: 1, steps: "Shake well with cracked ice, then strain into a chilled cocktail glass that has had its outside rim rubbed with lemon juice and dipped in sugar.", image_url: "http://esq.h-cdn.co/assets/15/18/640x640/square-1430427460-dmg-sidecar-cocktail-003.jpg", user_id: 4)
dirty_bongwater = Recipie.create(name: "Dirty Bongwater", difficulty: 2, description: "The premiere beverage of collegiate gentlemen.", servings: 1, steps: "Pour all ingredients in a glass with ice. Mix and enjoy.  Serve in a highball glass without garnish.", image_url: "http://www.ireadculture.com/wp-content/uploads/images/70/4170/4170.jpg", user_id: 3)
bloody_mary = Recipie.create(name: "Bloody Mary", tools: "shaker, strainer", difficulty: 5, description: "Neutral spirits, restorative juices, salts, capsaicins, and other volatile oils -- indicates that its origins lie in the shadowy world of the hangover cure, never to be listed on the more rarefied roster of nocturnal libations.", servings: 1, steps: "Squeeze the liquid out of the horseradish, then shake ingredients well with cracked ice in a chilled cocktail shaker, then strain into a Collins glass with 2 or 3 ice cubes in it; add a pinch of salt and a grind or two of fresh pepper, to taste. Garnish, if necessary, with a stalk of celery.", image_url: "http://esq.h-cdn.co/assets/cm/15/07/54dab41b0a606_-_bloodymary-004-de1.jpg", user_id: 2)
