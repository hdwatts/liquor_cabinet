...
Recipe.create!([
  ...
  {user_id: 3, name: "Manhattan", description: "When properly built, the Manhattan is the only cocktail that can slug it out toe-to-toe with the martini. It's bold and fortifying, yet as relaxing as a deep massage.", steps: "Fill a short glass 2/3 full with ice. Add bitters, vermouth, and bourbon. Add cherry (and crush it against the side of the glass with a spoon). Stir.", tools: nil, difficulty: 2, img_url: "http://www.bonappetit.com/wp-content/uploads/2010/05/mare-manhattan-v.jpg", servings: 1},
  ...
  {user_id: 3, name: "Paloma", description: "It turns out the Paloma, not the Margarita, is Mexico's most beloved cocktail.", steps: "Pour some kosher salt on a plate. Rub half of rim of a highball glass with grapefruit wedge; dip rim of glass in salt. Combine grapefruit juice, lime juice, and sugar in glass; stir until sugar is dissolved. Stir in mescal, add ice, and top off with club soda. Garnish with grapefruit wedge.", tools: nil, difficulty: 3, img_url: "http://www.bonappetit.com/wp-content/uploads/2012/12/paloma-940x600.jpg", servings: 1},
  ...
  {user_id: 3, name: "Dirty Bongwater", description: "The premiere beverage of collegiate gentlemen.", steps: "Pour all ingredients in a glass with ice. Mix and enjoy.  Serve in a highball glass without garnish.", tools: nil, difficulty: 2, img_url: "http://www.drinksecrets.com/images/drinks/megahuge/xxl_pornstar.png", servings: 2},
  ...
  {user_id: 3, name: "Ramos Gin Fizz", description: "This version of the classic New Orleans cocktail was created by Eben Freeman, bartender of Tailor restaurant in New York City.", steps: "In large cocktail shaker, combine gin, orange blossom water, egg white, half-and-half, lemon juice, lime juice, and simple syrup. Shake vigorously for 25 seconds. Add ice and shake for 30 seconds more. Strain mixture into 8-ounce glass. Slowly pour soda water down inside edge of shaker to loosen remaining froth. Gently ease soda water/froth mix onto drink and serve.", tools: nil, difficulty: 5, img_url: "http://theframedtable.com/wp-content/uploads/2012/02/V01gin_fizz0012-2.jpg", servings: 1},
  {user_id: 3, name: "Moscow Mule", description: "A Moscow Mule, also known as a Vodka buck, is a cocktail made with a high-quality vodka, a spicy ginger beer, and lime juice, garnished with a slice or wedge of lime.", steps: "Combine vodka and ginger beer in a copper mug or highball glass filled with ice. Add lime juice. Stir gently and garnish with a lime slice.", tools: nil, difficulty: 2, img_url: "http://www.bonappetit.com/wp-content/uploads/2012/12/paloma-940x600.jpg", servings: 1},
  ...
  {user_id: 3, name: "Negroni", description: "The Negroni cocktail is made of one part gin, one part vermouth rosso, and one part Campari, garnished with orange peel. It is considered an apéritif.", steps: "Stir into glass over ice, garnish and serve.", tools: nil, difficulty: 1, img_url: "http://www.campari.com/media/50664/negroni.png", servings: 3},
  {user_id: 3, name: "Aviation", description: "The Aviation is a classic cocktail made with gin, maraschino liqueur, crème de violette, and lemon juice. Some recipes omit the crème de violette.", steps: "Add all ingredients into cocktail shaker filled with ice. Shake well and strain into cocktail glass. Garnish with a cherry.", tools: nil, difficulty: 3, img_url: "http://liquor.s3.amazonaws.com/wp-content/uploads/2013/08/aviation.jpg", servings: 3},
  {user_id: 3, name: "White Russian", description: "A White Russian is a cocktail made with vodka, coffee liqueur, and cream served with ice in an Old Fashioned glass.", steps: "Pour coffee liqueur and vodka into an Old Fashioned glass filled with ice. Float fresh cream on top and stir slowly.", tools: nil, difficulty: 1, img_url: "http://liquor.s3.amazonaws.com/wp-content/uploads/2015/05/Draaanks-White-Russian-e1432674367165.jpeg", servings: 1},
  {user_id: 3, name: "Dirty Martini", description: "A dash of olive brine brings a salty, savory note to the all-time classic.", steps: "Add all the ingredients to a mixing glass filled with ice.", tools: nil, difficulty: 3, img_url: "http://liquor.s3.amazonaws.com/wp-content/uploads/2011/04/Dirty-Martini-newest.jpg", servings: 1},
  {user_id: 3, name: "Mint Julep", description: "The mint julep is a mixed alcoholic drink, or cocktail, consisting primarily of bourbon, water, crushed or shaved ice, and fresh mint.", steps: "In a highball glass gently muddle the mint, sugar and water. Fill the glass with cracked ice, add Bourbon and stir well until the glass is well frosted. Garnish with a mint sprig.", tools: nil, difficulty: 2, img_url: "http://farm9.staticflickr.com/8402/8697556486_01916df3c5_o.jpg", servings: 1},
