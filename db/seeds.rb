...
Recipe.create!([
  ...
  {user_id: 4, name: "Dirty Bongwater", description: "The premiere beverage of collegiate gentlemen.", steps: "Pour all ingredients in a glass with ice. Mix and enjoy.  Serve in a highball glass without garnish.", tools: nil, difficulty: 2, img_url: "http://www.drinksecrets.com/images/drinks/megahuge/xxl_pornstar.png", servings: 2},
  ...
  {user_id: 2, name: "Ramos Gin Fizz", description: "This version of the classic New Orleans cocktail was created by Eben Freeman, bartender of Tailor restaurant in New York City.", steps: "In large cocktail shaker, combine gin, orange blossom water, egg white, half-and-half, lemon juice, lime juice, and simple syrup. Shake vigorously for 25 seconds. Add ice and shake for 30 seconds more. Strain mixture into 8-ounce glass. Slowly pour soda water down inside edge of shaker to loosen remaining froth. Gently ease soda water/froth mix onto drink and serve.", tools: nil, difficulty: 5, img_url: "http://theframedtable.com/wp-content/uploads/2012/02/V01gin_fizz0012-2.jpg", servings: 1},
